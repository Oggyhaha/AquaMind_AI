...
export const DEMO_USERS: Record<string, User> = {
  super_admin: {
    ...
    status: 'active',
    permissions: ['view_dashboard', 'manage_users', 'manage_ai', 'view_audit_logs', 'system_settings', 'approve_task', 'assign_task', 'run_simulation']
  },
  state_authority: {
    id: 'user_state',
    name: 'Dr. Vikram Shah',
    ...
    status: 'active',
    permissions: ['view_dashboard', 'statewide_overview', 'approve_task', 'run_simulation', 'view_reports', 'create_task']
  },
  district_officer: {
    id: 'user_district',
    name: 'Amitabh Joshi',
    ...
    status: 'active',
    permissions: ['view_dashboard', 'district_overview', 'assign_task', 'verify_task', 'view_reports', 'ask_ai']
  },
  engineer: {
    id: 'user_engineer',
    name: 'Priya Desai',
    ...
    status: 'active',
    permissions: ['view_dashboard', 'my_tasks', 'upload_evidence', 'pipeline_health', 'update_task_status']
  },
  emergency_officer: {
    id: 'user_emergency',
    name: 'Sanjay Varma',
    ...
    status: 'active',
    permissions: ['view_dashboard', 'emergency_grid', 'request_dispatch', 'view_alerts']
  },
  researcher: {
    id: 'user_research',
    ...
    status: 'active',
    permissions: ['view_dashboard', 'historical_trends', 'export_data', 'view_reports']
  }
};
...
export const AI_RECOMMENDATIONS: AIRecommendation[] = [
  ...
  },
  {
    ...
    approvalComment: 'Reservoir release approved due to predicted 12-day shortage in Rajkot urban area.',
    digitalSignature: 'DIG-SIG-STATE-2026-9904'
  },
  {
    id: 'rec_105',
...
export const INITIAL_AGENTS: AgentState[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Generated standardized government action draft for instant digital signature approval'
    ]
  }
];

export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  { id: 'log_101', timestamp: '2026-07-29T10:15:02Z', userId: 'user_state', userName: 'Dr. Vikram Shah', role: 'state_authority', action: 'DIGITAL_APPROVAL_EXECUTED', details: 'Approved AI Recommendation #REC-301 with Digital Signature #DIG-SIG-STATE-2026-9904. Comment: Reservoir release approved.', ipAddress: '10.24.1.88', status: 'SUCCESS' },
